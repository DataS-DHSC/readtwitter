...
package but is a simplified version focussed on the API 2.0 endpoint for the 
Pro level of [paid subscription](https://developer.twitter.com/en/docs/twitter-api/getting-started/about-twitter-api). The latest feedback from `rtweet`
is that the package will no longer be maintained going forward after it's v2.0
release.
