...
The code if heavily influenced by the [`rtweet`](https://github.com/ropensci/rtweet)
package but makes use of the API 2.0 endpoint so is compatible with
the Basic level of [paid subscription](https://developer.twitter.com/en/docs/twitter-api/getting-started/about-twitter-api). The hope is that the next release of `rtweet`
will have support for API 2.0 endpoints making this package redundant.
